...
pub fn configure_routes(cfg: &mut web::ServiceConfig) {
    cfg.route("/api/changes", web::get().to(handlers::boards::check_changes))
        ...
        .route("/api/cards/{card_id}/checklist", web::post().to(handlers::cards::create_checklist_item))
        .route("/api/cards/{card_id}/checklist", web::put().to(handlers::cards::set_checklist_all))
        .route("/api/cards/{card_id}/checklist/{item_id}", web::put().to(handlers::cards::update_checklist_item))
        .route("/api/cards/{card_id}/checklist/{item_id}", web::delete().to(handlers::cards::delete_checklist_item))
